...
const Home = () => {
  ...
  return (
   <main className='home'>
    ...
    <div className="left">
        <textarea ref={focusRef} onChange={(e)=>{setJobDescription(e.target.value)}} value={jobDescription} name="jobDescription" id="jobDescription" placeholder="Enter job description"> </textarea>
    </div>
    ...
    <div className="right">
        <div className="input-group">
            ...
            <input ref={interviewRef} hidden type="file" name='resume' id='resume' accept='.pdf' />
            {!message == '' && (<p>{message}</p>) }
        </div>
        <div className="input-group">
            <label htmlFor="selfDescription">Self Description</label>
            <textarea onChange={(e)=>{setSelfDescription(e.target.value)}} value={selfDescription} name='selfDescription' id='selfDescription' placeholder='Enter Self Description'></textarea>
        </div>
        <button onClick={handleGenerateReport} disabled={loading} className="button button-primary">
    ...
    {reports && reports.length > 0 && (
        <section className="recent-reports">
            <div className="section-header">
                ...
                <p className="report-count">{reports.length} {reports.length === 1 ? 'report' : 'reports'}</p>
            </div>
                        ...
                        >
                            ...
                            <div className="report-meta">
                                ...
                                <span className="meta-item">
                                    ...
                                    <span className="meta-value" style={{color: scoreTheme.primary}}>
                                        {scoreTheme.label}
                                    </span>
                                </span>
                            </div>
